      ...
      <div className="commonSectionWrapper hasura-light-blue-bg-color">
        ...
        <div className="containerWrapper">
          <div className="newsletterWrapper">
            <div>
              <div className="hasura-ibm-plex-sub-title">Ready to get started?</div>
              <div className="articleDesc">
                Start for free on Hasura Cloud or you could contact our sales team for a detailed
                walk-through on how Hasura may benefit your business.
              </div>
              <div className="buttonWrapper">
                <a
                  href={`https://cloud.hasura.io/signup?pg=${utmPagePathName}&plcmt=footer&cta=try-hasura&tech=default`}
                >
                ...
                <a href="https://hasura.io/contact-us/?type=hasuraenterprise">
                  <button className="hasura-btn hasura-btn-md hasura-white-btn">
                    CONTACT SALES
                  </button>
                </a>
              </div>
        ...
        <div className="containerWrapper">
          ...
          <div className="footerWrappper wd100">
            <div className="footerLinks hasura-ibm-plex-nav">
              ...
              <a href="https://hasura.io/about/" className="links">
                About Us
              </a>
              <a href="https://hasura.io/press/" className="links">
                Press
              </a>
              <a href="/careers/" className="links">
                Careers
              </a>
              <a href="https://hasura.io/contact-us/" className="links">
                Contact Us
              </a>
              <a href="https://hasura.io/legal/" className="links">
                Legal Stuff
              </a>
            </div>
            <div className="footerLinks hasura-ibm-plex-nav">
              ...
              <a href="https://hasura.io/help/" className="links">
                Website chat
              </a>
              <a
            ...
            <div className="footerLinks hasura-ibm-plex-nav">
              ...
              <a href="https://hasura.io/opensource/" className="links">
                Hasura Open Source
              </a>
              <a href="https://hasura.io/cloud/" className="links">
                Hasura Cloud
              </a>
              <a href="https://hasura.io/enterprise/" className="links">
                Hasura Enterprise
              </a>
              <a href="https://hasura.io/pricing/" className="links">
                Pricing
              </a>
              <a
            ...
            <div className="footerLinks hasura-ibm-plex-nav">
              ...
              <a href="https://hasura.io/case-studies/" className="links">
                case Studies
              </a>
              <a
              ...
              <a href="https://hasura.io/event-driven-programming/" className="links">
                Event Driven Programming
              </a>
              <a href="https://hasura.io/react-graphql/" className="links">
                React GraphQL
              </a>
              <a href="https://hasura.io/vue-graphql/" className="links">
                Vue GraphQL
              </a>
              <a href="https://hasura.io/diy-graphql-baas/" className="links">
                DIY GraphQL BaaS
              </a>
              <a href="https://hasura.io/graphql/" className="links">
                GraphQL & Hasura
              </a>
              <a href="https://hasura.io/security/" className="links">
                Hasura Cloud Security
              </a>
            </div>
            <div className="footerLinks hasura-ibm-plex-nav">
              <div className="footerLinksHeader">Community</div>
              <a href="https://hasura.io/community/" className="links">
                Community Resources
              </a>
              <a
              ...
              <a href="https://hasura.io/sample-apps/" className="links">
                Sample Apps
              </a>
              <a href="https://hasura.io/partner-agencies/" className="links">
                Partnership Program
              </a>
              <a
